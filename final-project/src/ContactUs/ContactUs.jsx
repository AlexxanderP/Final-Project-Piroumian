      ...
      <div className="contact-container">
        <div className="contact-info-container">
          <p className="hourly-estimate">
            For hourly estimates, or to have an Air Scrubber installed, please
            contact us at your convenience. <br /> We look forward to meeting
            you soon.
          </p>
          <h2 className="landeen-contact">
            {" "}
            Landeen Heating & Air Conditioning
          </h2>
          <p className="location"> Santa Clarita, California, United States</p>
          <a className="contact-number" href="tel:555-558-5691">
            555.555.5691
          </a>
          <h3 className="follow-us"> Follow us on social media!</h3>
          <div className="facebook-container">
            <img className="facebook-logo" src={facebook} alt="facebook logo" />
            <a className="facebook-username" href="https://www.Facebook.com">
              LandeenAir
            </a>
          </div>
          <div className="instagram-container">
            <img
              ...
              alt="instagram logo"
            />
            <a className="instagram-username" href="https://www.instagram.com">
              LandeenAir
            </a>
          </div>
        </div>
